    ...
    <Navbar/>
      <div className="container mx-auto bg-violet-50 my-5 rounded-xl p-5 min-h-[80vh]">
          <div className="addTodo my-5">
            ...
            <button onClick={handleAdd} className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-white rounded-md mx-6'>Save</button>
          </div>
          ...
          <div className="todos">
            ...
            return <div key={item.id} className="todo flex justify-between w-1/4 my-3">
             ...
             <div className="buttons">
              ...
              <button onClick={(e)=>{handleDelete(e, item.id)}} className='bg-violet-800 hover:bg-violet-950 p-2 py-1 text-white rounded-md mx-1'>Delete</button>
             </div>
            </div>
            })}
          </div>
